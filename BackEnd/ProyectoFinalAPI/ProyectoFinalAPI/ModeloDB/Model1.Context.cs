...
namespace ProyectoFinalAPI.ModeloDB
{
    ...
    public partial class Proyecto_FinalEntities : DbContext
    {
        ...
        public virtual ObjectResult<ConsultarTestimonios_Result> ConsultarTestimonios()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<ConsultarTestimonios_Result>("ConsultarTestimonios");
        }
